#!/usr/bin/env python3
"""Run CL experiments - Split MNIST."""
import sys
import os
...
from cl_benchmarks import create_split_mnist, SimpleMLP, train_model, evaluate_model
...
if __name__ == '__main__':
    ...
    start = time.time()
    train_loaders, test_loaders = create_split_mnist(num_tasks=5)
    results = run_quick(
    ...
    with open('split_mnist_results.json', 'w') as f:
